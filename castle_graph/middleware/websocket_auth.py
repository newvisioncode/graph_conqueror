...
class JWTAuthMiddleware:
    ...
    async def __call__(self, scope, receive, send):
        ...
        try:
            ...
            temp = await self.get_user(data['user_id'])
            scope['user'] = temp
            scope['contest_group'] = temp.contestuser.group
            scope['contest_user'] = temp.contestuser
    ...
    def get_user(self, user_id):
        ...
        try:
            return User.objects.select_related('contestuser', 'contestuser__group').get(id=user_id)
